    ...
    <div className="goal-layout">
      <div className="goal-col">
        <div className="card glass">
          <div className="card-h"><h3>{g.listTitle}</h3></div>
          {goals.length ? <div className="grid g-2">
            {goals.map((goal) => {
      ...
      <div className="goal-col">
        <div className="card glass">
          <div className="card-h"><h3>{editingId ? g.editTitle : g.newTitle}</h3></div>
          ...
          <div className="goal-actions"><button className="btn btn-primary" disabled={saving} onClick={submit}>{editingId ? g.updateForecast : g.createForecast}</button></div>
        </div>

        {editingId && <div className="card glass">
          ...
          <div className="goal-actions"><button className="btn btn-primary" disabled={saving} onClick={addContribution}>{saving ? g.saving : g.addContribution}</button></div>
        </div>}
      </div>
    </div>
  </div>;
