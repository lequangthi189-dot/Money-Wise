...
export const i18n = {
  vi: {
    ...
    titles: {
      ...
      admin: ["Quản trị hệ thống", "Thống kê tổng quan toàn hệ thống"],
    ...
    admin: {
      ...
      newUsers: (n) => `+${n} mới trong tháng`,
      totalIncome: "Tổng thu toàn hệ thống",
      totalExpense: "Tổng chi toàn hệ thống",
      userGrowth: "Tăng trưởng người dùng",
      vsLastMonth: "so với tháng trước",
      newUsersByMonth: "Người dùng mới theo tháng",
      barChart: "Biểu đồ cột",
      systemTrend: "Xu hướng thu/chi toàn hệ thống",
      lineChart: "Biểu đồ đường",
      months6: ["T1", "T2", "T3", "T4", "T5", "T6"],
  ...
  en: {
    ...
    titles: {
      ...
      admin: ["System Admin", "System-wide overview & statistics"],
    ...
    admin: {
      ...
      newUsers: (n) => `+${n} new this month`,
      totalIncome: "Total system income",
      totalExpense: "Total system expense",
      userGrowth: "User growth",
      vsLastMonth: "vs last month",
      newUsersByMonth: "New users by month",
      barChart: "Bar chart",
      systemTrend: "System-wide income/expense trend",
      lineChart: "Line chart",
      months6: ["Jan", "Feb", "Mar", "Apr", "May", "Jun"],
