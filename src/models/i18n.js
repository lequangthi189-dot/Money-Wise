...
export const i18n = {
  vi: {
    ...
    profile: {
      ...
      streakLostMissingDay: "Chuỗi chỉ bị mất khi sang ngày kế tiếp mà bạn không ghi chép giao dịch.",
    ...
    dashboard: {
      ...
      streakLostReason: (date) => `Không ghi chép vào ngày kế tiếp · lần gần nhất ${date}`,
      unknownDate: "chưa xác định",
    ...
    chat: {
      ...
      notePlaceholder: "Mô tả giao dịch…",
      category: "Danh mục",
      method: "Phương thức",
      date: "Ngày",
  ...
  en: {
    ...
    profile: {
      ...
      streakLostMissingDay: "The streak is lost only when no transaction is recorded on the following day.",
      unknownDate: "unknown",
      joined: (d) => `Joined ${d}`,
      logout: "Log out",
    ...
    dashboard: {
      ...
      streakLostReason: (date) => `No entry on the following day · last entry ${date}`,
      unknownDate: "unknown",
    ...
    chat: {
      ...
      amount: "Amount",
      note: "Content / Note",
      notePlaceholder: "Describe the transaction…",
      category: "Category",
      method: "Method",
      date: "Date",
