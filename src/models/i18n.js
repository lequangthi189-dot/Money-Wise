...
export const i18n = {
  vi: {
    ...
    profile: {
      ...
      streakLostTitle: "Vì sao chuỗi bị mất?",
      streakLostReason: (date) => `Lần ghi chép gần nhất: ${date}.`,
      streakLostMissingDay: "Không có giao dịch nào được ghi nhận trong ít nhất một ngày.",
      streakLostDeletedDay: "Giao dịch duy nhất của một ngày trong chuỗi đã bị xóa.",
    ...
    dashboard: {
      ...
      streakLostReason: (date) => `Chuỗi bị gián đoạn · ghi chép gần nhất ${date}`,
      unknownDate: "chưa xác định",
  ...
  en: {
    ...
    profile: {
      ...
      streakLostTitle: "Why was the streak lost?",
      streakLostReason: (date) => `Last recorded activity: ${date}.`,
      streakLostMissingDay: "No transaction was recorded for at least one day.",
      streakLostDeletedDay: "The only transaction recorded on a streak day was deleted.",
      unknownDate: "unknown",
      joined: (d) => `Joined ${d}`,
      logout: "Log out",
    ...
    dashboard: {
      ...
      streakLostReason: (date) => `Streak interrupted · last entry ${date}`,
      unknownDate: "unknown",
